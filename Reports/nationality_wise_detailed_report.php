...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Detailed Nationality Report</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Detailed Nationality Report</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    <table id="example1" class="table table-bordered projects ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>Jordan</td>
                                                <td>Adam Muneer Mohammad Al Ramahi</td>
                                                <td>1</td>
                                                <td>12</td>
                                                <td>493,950</td>
                                                <td>1%</td>
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td>Jordan</td>
                                                <td>Ahmad Amin Mustafa Almusa</td>
                                                <td>1</td>
                                                <td>12</td>
                                                <td>250,000</td>
                                                <td>1%</td>
