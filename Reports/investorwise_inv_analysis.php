                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-info float-right" href="../Reports/investorwise_inv_detailed.php">Detailed report</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered projects ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> % of Grand Total on Investment</th>
                                                <!-- <th></th> -->
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>1,801,034</td>
                                                <td>12.66%</td>
                                                <!-- <td><a href="../Reports/investment_person_detailed.php" class="btn btn-info">View</a></td> -->
                                            </tr>
                                            <tr>
                                                <td>2</td>
