...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Month wise Investment Summary</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Month wise Investment Summary</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered projects ">
                                        <thead>
                                            ...
                                            $date1 = '2023-06-01';
                                            $date2 = date('Y-m-d');
                                            $month = strtotime($date1);
                                            ?>
                                            <tr>
                                                <th rowspan="2">#</th>
                                                <th rowspan="2">Investor Name</th>
                                                <th colspan="7" style="text-align: center;">2023</th>
                                                <th rowspan="2">2023 Total</th>
                                                <th colspan="12" style="text-align: center;">2024</th>
                                                <th rowspan="2">2024 Total</th>
                                                <th colspan="9" style="text-align: center;">2025</th>
                                                <th rowspan="2">2025 Total</th>
                                                <th rowspan="2">Grand Total</th>
                                            </tr>
                                            <tr>
                                                <?php while ($month < strtotime($date2)) { ?>
                                                    <th><?= date('F', $month), PHP_EOL; ?></th>
                                                <?php
                                    ...
                                    <div class="col-12 mt-4">
                                        <a href="../Reports/investorwise_inv_analysis.php" class="btn btn-default float-left">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
