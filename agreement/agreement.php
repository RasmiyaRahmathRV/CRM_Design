                        ...
                        <div class="card-header">
                            ...
                            <span class="float-right">
                                <button class="btn btn-info float-right m-1" data-toggle="modal"
                                    data-target="#modal-agreement">Add Agreement</button>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-sm" title="Terminate" data-toggle="modal" data-target="#modal-terminate"><i class="fas fa-file-signature"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                        ...
                                        <div id="lead-step" class="content" role="tabpanel" aria-labelledby="lead-step-trigger">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="client_name" placeholder="Tenant Name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <label for="exampleInputEmail1">Emirates ID/Passport/Trde license</label>
                                                    <input type="text" class="form-control" id="client_phone" placeholder="Emirates ID/Passport/Trde license">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="exampleInputEmail1">Tenant mobile</label>
                                                    <input type="text" class="form-control" id="client_email" placeholder="Tenant mobile">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-4">
                                                    <label for="exampleInputEmail1">Tenant email</label>
                                                    <input type="text" class="form-control" id="contact_person" placeholder="Tenant email">
                                                </div>
                                                <div class="col-md-4">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="input-group date" id="terminationdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#terminationdate" placeholder="dd-mm-YYYY" />
                                        <div class="input-group-append" data-target="#terminationdate" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                </div>
