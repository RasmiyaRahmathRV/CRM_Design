...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid p-5">
            <table width="1025" border="2" align="center" cellpadding="0" cellspacing="0" style="box-shadow:-4px 4px 20px #666" ;>
                <tr height="21">
                                ...
                                <td height="70">
                                    <table width="100%" height="70" border="0" align="center" cellpadding="10">
                                        <tr>
                                            <td height="66">
                                                <strong>
                                                    <img width="280" height="90" src="../images/Fama Real Estate Logo PNG.png" alt="fama-logo" style="margin-left: 10px;" />
                                                </strong>
                                            </td>
                                            <td>
                        ...
                        <table width="100%" border="1" align="center">
                            <tr>
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm">
                                        <strong> <span class="text-sm text-sm style14">Building Management</span></strong>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" width="41.9%" bgcolor="#FFFFFF">
                                    <div class="text-sm text-sm ml-1">
                                        <strong> <span class="text-sm text-sm style14">FAATEH REAL ESTATE</span></strong>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td width="26.5%" bgcolor="#FFFFFF" colspan="2">
                                    <div class="text-sm text-sm ml-1">
                                        <strong> <span class="text-sm text-sm style14">Refundable Security Deposit</span></strong>
                                    </div>
                                </td>
                                <td bgcolor="#FFFFFF" colspan="3" width="41.9%">
                                    <div class="text-sm text-sm ml-1">
                        ...
                        <table width="100%" border="1" align="center">
                            <tr>
                                ...
                                <td width="22%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Cash/ Cheque/ Transfer</strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #1: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #2: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #3: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #4: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #5: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #6: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #7: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #8: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #9: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #10: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #11: </strong></div>
                                </td>
                                <td width="15%" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <div align="center" class="text-sm text-sm"><strong>Bank Transfer #12: </strong></div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td width="15%" colspan="3" bgcolor="#FFFFFF">
                                    <div class="text-sm text-sm ml-1"><strong>All as above on or before due date</strong></div>
                                </td>
                            </tr>

                            <tr>
                                <td width="100%" colspan="4" bgcolor="#FFFFFF">
                                    <div class="text-xs ml-1" style="font-size: .65rem !important"><strong>Additional Terms:</br>
                                            1. I the tenant hereby agree to follow the laws of the UAE and undertake not to carry out any illegal activity in the above premises. If there is breach of this rule, I undertake to vacate the premises immediately without any compensation.</br>
                                            2. It is agreed that if any of the cheque issued by the tenant for rental or other payments is returned unpaid by the bank for any reason then there will be a penalty of AED 1000/- for each cheque on each occasion plus the tenant has to make good the cheque amount by cash immediately failing which he will have to vacate the premises immediately and landlord has full right to enter and take over the flat in the event of non-payment of rent.</br>
                                            3. Tenant hereby confirms and agrees with the Landlord that they will not hang clothes to dry in the balconies and outside the windows in compliance with municipal regulations and if there is breach on the part of the tenant then he is responsible for the municipal fines if any.</br>
                                            4. Tenant hereby confirms and agrees with the Landlord that more than 4 persons will not occupy a flat at any time.</br>
                                            5. Tenant hereby confirms and agrees that they will not make any alteration or additions in the leased premises and not to fix showers in half bathrooms.</br>
                                            6. All levies due to the Government including VAT or other levies as and when applicable is payable by the tenant.</br>
                                            7. Tenant must inform the landlord 90 days before expiry of contract whether they want to renew or vacate the Unit and if the Tenant fails to inform then contract will be renewed for 1 year.</br>
                                            8. Tenant must pay an amount of AED 1000/- as Admin Charges.</br>
                                            9. In case of Contract cancellation, Faateh Real Estate must return the flat same as at time of procurement time.</br>
                                        </strong>
                                    </div>
                                </td>
                            </tr>
