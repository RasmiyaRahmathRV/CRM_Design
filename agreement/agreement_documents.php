                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-form-label">Upload Emirates ID</label>
                                    <input type="file" name="file" class="form-control">
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-form-label">Upload Passport</label>
                                    <input type="file" name="file" class="form-control">
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-form-label">Upload Visa</label>
                                    <input type="file" name="file" class="form-control">
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-form-label">Upload Agreement</label>
                                    <input type="file" name="file" class="form-control">
                                </div>
                            </div>
                            <!-- /.card-body -->
