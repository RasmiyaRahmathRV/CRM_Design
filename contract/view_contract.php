                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                ...
                                <?php if (isset($_GET['1'])) { ?>
                                    ...
                                    <button type="button" class="btn btn-success float-right"><i class="fas fa-upload"></i> Upload Contract </button>
                                    <button type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
                                        <i class="fas fa-envelope-open-text"></i> Generate Scope

                                    <?php } else if (isset($_GET['2'])) { ?>
                                        <button type="button" class="btn btn-success float-right"><i class="far fa-eye"></i> View Contract </button>
                                        <button type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
