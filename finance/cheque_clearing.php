                        ...
                        <div class="card-body">
                                    ...
                                    <div class="form-group row m-4">
                                        <div class="col-md-1 ml-4">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="radioPrimary1" class="radioType" value="1" name="r1" checked>
                                        ...
                                        <div class="col-md-1">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="radioPrimary2" class="radioType" value="2" name="r1">
                            ...
                            <div class="card searchCheque">
                                ...
                                <div class="card-header">
                                    <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#modal-success-clear-all">Clear All</button>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="input-group date" id="returndate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#returndate" placeholder="dd-mm-YYYY" />
