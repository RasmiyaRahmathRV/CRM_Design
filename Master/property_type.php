...
<div class="content-wrapper">
    ...
    <section class="content">
                        ...
                        <div class="card-header">
                            ...
                            <span class="float-right">
                                <button class="btn btn-info float-right m-1" data-toggle="modal"
                                    data-target="#modal-propert-type">Add Property Type</button>
        ...
        <div class="modal fade" id="modal-propert-type">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="" id="Property TypeForm">
                        <input type="hidden" name="id" id="Property Type_id">
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label">Property Type</label>
                                    <input type="text" name="Property Type_name" id="Property Type_name" class="col-sm-8 form-control"
                                        id="inputEmail3" placeholder="Property Type">
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
        ...
        <div class="modal fade" id="modal-import">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="" id="Property TypeImportForm" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="form-group row">
