                        ...
                        <div class="card-header">
                            ...
                            <span class="float-right">
                                <button class="btn btn-info float-right m-1" data-toggle="modal"
                                    data-target="#modal-Nationality">Add Nationality</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-info" data-toggle="modal"
                                                data-target="#modal-Nationality">Edit</button>
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="Nationality_name" id="Nationality_name" class="col-sm-8 form-control"
                                        id="inputEmail3" placeholder="Nationality Name">
                                </div>
        ...
        <div class="modal fade" id="modal-import">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="" id="NationalityImportForm" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="form-group row">
