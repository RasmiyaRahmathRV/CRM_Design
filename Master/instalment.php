...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <!-- <h3 class="card-title">Instalment Details</h3> -->
                            <span class="float-right">
                                <button class="btn btn-info float-right m-1" data-toggle="modal"
                                    data-target="#modal-Instalment">Add Instalment</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-info" data-toggle="modal"
                                                data-target="#modal-Instalment">Edit</button>
        ...
        <div class="modal fade" id="modal-Instalment">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="" id="InstalmentForm">
                        <input type="hidden" name="id" id="Instalment_id">
                        <div class="modal-body">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="Instalment_name" id="Instalment_name" class="col-sm-9 form-control"
                                        id="inputEmail3" placeholder="Interval">
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
        ...
        <div class="modal fade" id="modal-import">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="" id="InstalmentImportForm" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="form-group row">
